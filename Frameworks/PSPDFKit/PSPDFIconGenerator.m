        ...
        if (!iconImage) {
            switch (iconType) {
                ...
                case PSPDFIconTypeEmail: {
                    UIGraphicsBeginImageContextWithOptions(CGSizeMake(26, 22.f), NO, 0.f);
                    [[UIColor whiteColor] setFill];
                    [[UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 6, 24, 14) cornerRadius:1] fill];
                    UIBezierPath* lowerBezierPath = [UIBezierPath bezierPath];
                    [lowerBezierPath moveToPoint:CGPointMake(0, 20)];
                    [lowerBezierPath addLineToPoint:CGPointMake(12, 7)];
                    [lowerBezierPath addLineToPoint:CGPointMake(24, 20)];
                    [lowerBezierPath strokeWithBlendMode:kCGBlendModeClear alpha:1];
                    UIBezierPath* upperBezierPath = [UIBezierPath bezierPath];
                    [upperBezierPath moveToPoint:CGPointMake(0, 6)];
                    [upperBezierPath addLineToPoint:CGPointMake(12, 14)];
                    [upperBezierPath addLineToPoint:CGPointMake(24, 6)];

...
+ (CGSize)renderPage:(CGPDFPageRef)page inContext:(CGContextRef)context {
	return [PSPDFPageRenderer renderPage:page inContext:context atPoint:CGPointMake(0, 0) withZoom:100 pageInfo:nil interpolationQuality:kCGInterpolationHigh];
}

+ (CGSize)renderPage:(CGPDFPageRef)page inContext:(CGContextRef)context atPoint:(CGPoint)point {
	return [PSPDFPageRenderer renderPage:page inContext:context atPoint:point withZoom:100 pageInfo:nil interpolationQuality:kCGInterpolationHigh];
}
...
+ (CGSize)renderPage:(CGPDFPageRef)page inContext:(CGContextRef)context atPoint:(CGPoint)point withZoom:(float)zoom pageInfo:(PSPDFPageInfo *)pageInfo {
  return [PSPDFPageRenderer renderPage:page inContext:context atPoint:point withZoom:zoom pageInfo:pageInfo interpolationQuality:kCGInterpolationHigh];
}
...
+ (CGRect)renderPage:(CGPDFPageRef)page inContext:(CGContextRef)context inRectangle:(CGRect)displayRectangle pageInfo:(PSPDFPageInfo *)pageInfo {
  return [PSPDFPageRenderer renderPage:page inContext:context inRectangle:displayRectangle pageInfo:pageInfo interpolationQuality:kCGInterpolationHigh];
}

+ (CGRect)renderPage:(CGPDFPageRef)page inContext:(CGContextRef)context inRectangle:(CGRect)displayRectangle pageInfo:(PSPDFPageInfo *)pageInfo interpolationQuality:(CGInterpolationQuality)interpolationQuality {

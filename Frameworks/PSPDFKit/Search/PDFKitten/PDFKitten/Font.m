...
+ (Font *)fontWithDictionary:(CGPDFDictionaryRef)dictionary
{
	...
	{
		return [[Type0Font	alloc] initWithFontDictionary:dictionary];
	}
	else if (strcmp(subtype, "Type1") == 0)
	{
		return [[Type1Font alloc] initWithFontDictionary:dictionary];
	}
	else if (strcmp(subtype, "MMType1") == 0)
	{
		return [[MMType1Font alloc] initWithFontDictionary:dictionary];
	}
	else if (strcmp(subtype, "Type3") == 0)
	{
		return [[Type3Font alloc] initWithFontDictionary:dictionary];
	}
	else if (strcmp(subtype, "TrueType") == 0)
	{
		return [[TrueTypeFont alloc] initWithFontDictionary:dictionary];
	}
	else if (strcmp(subtype, "CIDFontType0") == 0)
	{
		return [[CIDType0Font alloc] initWithFontDictionary:dictionary];
	}
	else if (strcmp(subtype, "CIDFontType2") == 0)
	{
		return [[CIDType2Font alloc] initWithFontDictionary:dictionary];
	}
	return nil;
}

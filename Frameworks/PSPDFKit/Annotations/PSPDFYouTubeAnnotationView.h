...
/// Uses MPMoviePlayerController whenever possible, else falls back to the WKWebView YouTube plugin.
...
/// YES to enable auto-start as soon as the view is loaded. Relayed to PSPDFVideoAnnotationView. Doesn't work with WKWebView.

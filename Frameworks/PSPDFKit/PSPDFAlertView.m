...
static char kPSPDFAlertViewKey;
...
- (void)show {
    // retain ourselves
    objc_setAssociatedObject(view_, &kPSPDFAlertViewKey, self, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    [view_ show];
}
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    // remove retain cycle
    objc_removeAssociatedObjects(view_);
}
